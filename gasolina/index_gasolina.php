...
<form action="insert_gasolina.php" method="post">
  <div class="mb-3 container">
    ...
    <input type="text" class="form-control" name="ano_gasolinacaio" id="ano_gasolinacaio">
  </div>
  <div class="mb-3 container">
    <label for="valor_gasolinacaio" class="form-label">Valor</label>
    <input type="text" class="form-control" name="valor_gasolinacaio" id="valor_gasolinacaio">
  </div>
  <div class="container">
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        ?>
          ...
          ['<?= $item['anogasolinacaio']; ?>',  <?= $item['valorgasolinacaio'];?>],
