...
<form action="insert_carro.php" method="post">
  <div class="mb-3 container">
    ...
    <input type="text" class="form-control" name="ano_carrocaio" id="ano_carrocaio">
  </div>
  <div class="mb-3 container">
    <label for="valor_carrocaio" class="form-label">Valor</label>
    <input type="text" class="form-control" name="valor_carrocaio" id="valor_carrocaio">
  </div>
  <div class="container">
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        ?>
          ...
          ['<?= $item['anocarrocaio']; ?>',  <?= $item['valorcarrocaio'];?>],
