...
<form action="insert_pib.php" method="post">
  <div class="mb-3 container">
    ...
    <input type="text" class="form-control" name="ano_pibcaio" id="ano_pibcaio">
  </div>
  <div class="mb-3 container">
    <label for="valor_pibcaio" class="form-label">Valor</label>
    <input type="text" class="form-control" name="valor_pibcaio" id="valor_pibcaio">
  </div>
  <div class="container">
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        ?>
          ...
          ['<?= $item['anopibcaio']; ?>',  <?= $item['valorpibcaio'];?>],
