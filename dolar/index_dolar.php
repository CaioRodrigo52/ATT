...
<form action="insert_dolar.php" method="post">
  <div class="mb-3 container">
    ...
    <input type="text" class="form-control" name="ano_dolarcaio" id="ano_dolarcaio">
  </div>
  <div class="mb-3 container">
    <label for="valor_dolarcaio" class="form-label">Valor</label>
    <input type="text" class="form-control" name="valor_dolarcaio" id="valor_dolarcaio">
  </div>
  <div class="container">
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        ?>
          ...
          ['<?= $item['anodolarcaio']; ?>',  <?= $item['valordolarcaio'];?>],
